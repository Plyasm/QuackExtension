const translates = {
    ...
    //周瑜
    "#dhs_xiongziyingfa1": "交兵不假挥长剑，已挫英雄百万师。",
    "#dhs_xiongziyingfa2": "上窥青天，下潜黄泉，挥斥八极，卫我吴疆。",
    "#dhs_huoshaochibi1": "此计已成，定鼎乾坤。",
    "#dhs_huoshaochibi2": "烈焰炽盛，愈燃愈烈！",
    "#dhs_huoshaochibishow1": "烈火燎原，破贼瞬息。",
    "#dhs_huoshaochibishow2": "百舸竞发，借吾东风！",
    "#dhs_huoshaochibifail1": "天时不可违，也罢。",
    "#dhs_huoshaochibifail2": "东风不与，为之奈何.",
    "#dhs_fanjianji1": "反间者，因其敌间而用之。",
    "#dhs_fanjianji2": "反间计，疑中之疑。",
    "#dhs_fanjianjistun1": "间者，使敌自相疑忌也。",
    "#dhs_fanjianjistun2": "比之自内，不自失也。",
    
    //英布
    "#dhs_gongguanzhuhou1": "吾有彪炳功业，虽诸侯不能及。",
    "#dhs_gongguanzhuhou2": "计功而行赏，程能而授事。",
    "#dhs_daxiguowang1": "哈哈哈哈哈甚合吾意！",
    "#dhs_daxiguowang2": "据有先机，更胜所愿",
    
    //虞姬
    "#dhs_meiren1": "美人从来配英雄。",
    "#dhs_meiren2": "死生契阔，与子成说。",
    "#dhs_meirenhusband1": "多谢相救",
    "#dhs_meirenhusband2": "有劳将军",
    "#dhs_meirenwife1": "相濡以沫，死生相随。",
    "#dhs_merirenwife2": "乱世相携，还报君恩。",
